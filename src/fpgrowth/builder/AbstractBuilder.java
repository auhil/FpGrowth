...
import fpgrowth.node.AssociationRule;
import fpgrowth.node.AssociationRuleHelper;

public abstract class AbstractBuilder {

	/** 最小支持度 */
	protected int minSupport = 3;
	/** 最小置信度 */
	...
	protected void calculateConfidence(Data data, AssociationRule associationRule) {
		...
		if (rightSup != 0) {
			...
			if (confidence >= minConfidence && !AssociationRuleHelper.isContain(associationRules, associationRule)) {
