...
import fpgrowth.node.FPTreeNode;
import fpgrowth.utils.ShowUtils;
...
public class FPGrowthBuilder extends AbstractBuilder {
	...
	// 新增树节点
	private void addNewTreeNode(FPTreeNode parent, LinkedList<String> items, List<FPTreeNode> headerTables) {
		while (items.size() > 0) {
